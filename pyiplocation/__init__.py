...
def geolocate(ip: str):
    ...
    return {
        ...
        "country_codes": {"alpha-2": page[164].replace("<td>", "").replace("</td>", ""), "alpha-3": page[168].replace("<td>", "").replace("</td>", "")},
        ...
        "latitude": page[202].replace("<td>", "").replace("</td>", "").split(", ")[0],
        "longitude": page[202].replace("<td>", "").replace("</td>", "").split(", ")[1],
        "geoname_id": page[206].replace("<td>", "").replace("</td>", ""),
        ...
        "currency": page[242].replace("<td>", "").replace("</td>", ""),
        "currency_code": page[247][-7:].replace("<td>", "").replace("</td>", "").replace("</a>", ""),
        "currency_symbol": page[252].replace("<td>", "").replace("</td>", ""),
        "timezone": page[256].replace("<td>", "").replace("</td>", ""),
        "timezone_offset": page[260].replace("<td>", "").replace("</td>", ""),
        # kinok
    }

print(geolocate("12.34.5.6"))